...
rast_list[[4]]<-brick(paste0(output_fold,'./Intermediate/ssp_ensemble_heat.tif'))
rast_list[[5]]<-brick(paste0(output_fold,'./Intermediate/ssp_ensemble_drought.tif'))
rast_list[[6]]<-brick(paste0(output_fold,'./Intermediate/ssp_ensemble_flood.tif'))
